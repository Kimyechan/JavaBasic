...
// 제네릭 클래스
// 클래스를 선언 할 때에는 설정되지 않은 타입이 있으며, 이것을 타입 파라미터로 표헌
...
//    T memberVar = new T(); // not possible -> 안전성 문제 때문에 불가능
//    {
//        Object obj = new Object();
//            if (obj instanceof T) // not possible -> 안전성 문제 때문에 불가능
//    }
}
...
class GenericMethod{
    ...
    public static <T, V, X> T staticMethod1(V v, X x){
        return (T) "";
    }
}
...
class WildCard {
    ...
    public void method2(WildGeneric<? extends WildFoo> x) {} // WildFoo, WildBar, Super -> WildFoo 상속한 하위객체
    public void method3(WildGeneric<? super  WildBar> x) {} // Object, WildFoo, WildBar -> 상위 객체
}
public class Generics {
    public static void main(String[] args) {
        ...
        // 동적 바인딩 -> 컴파일타입에는 동작이 완전히 정의가 되지 않음
        // 런타임에 결정이 된다.
