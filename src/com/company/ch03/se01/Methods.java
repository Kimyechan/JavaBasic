...
/**
 * 메소드(Methods)
 * 객체가 하는 동작을 정의하는 작업을 수행하는 코드이 집합, 나열
 * 코드의 증복을 방지, 유지보수성을 향상, 코드의 가독성 개선
 */
...
class Bar {
    ...
    // 함수명은 같고, 입려인자가 달라야 합니다.
    // 입력 인자의 개수도 다들 수 있다.
    public static int sumAll(float ... params) {
        int sum = 0;
...
//      클래스 메소드는 객체의 속성과 상관이 없다.
        ...
        System.out.println(Bar.sumAll(2.2f, 1.5f, 2.1f, 10.7f, 6.4f, -2.9f));
