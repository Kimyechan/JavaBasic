...
class Car { //클래스의 이름은 보통 PascalCase로 적는다
    int speed = 0; //속성, 맴버 변수
    // 속성 : attribute, field
    // 맴버 변수 : member variable

    void move () { // 메소드 (method)
...
public class ClassBasic {
    ...
    public static void main(String[] args) {
        Car carOne = new Car(); //new 키워드로 클래서에서 객체 생성
        ...
        Car carThree = carOne; // 참조형 객체이므로 객체를 만들지 않았다.
