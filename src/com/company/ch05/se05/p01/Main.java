package com.company.ch05.se05.p01;
...
/**
 * Stream API
 * JAVA 8에 추가된 java.util.stream 패캐지
...
public class Main {
    public static void main(String[] args) {
        ...
        // JAVA8 - Stream API -> 휠씬 더 간결한 코드로 작성
        ...
        // 스트림 생성 방식2.
        int[] ints = {4, 6, 2, 19, 58, 4, 6, 5};
        // Arrays 클래의 클래스 메소드 stream
        IntStream intStream = Arrays.stream(ints);
        // LongStream, DoubleStream

        // 스트림 생성 방식3.
        // Stream 클래스의 클래스 메소드 of
        DoubleStream doubleStream = DoubleStream.of(0.4, 0.6, 1.2, 0.94);
...
//        longStream.forEach(System.out::println);
        ...
        stringStream = Stream.of("abc", "fwf", "twtoe", "dnmov", "word");
        ...
        // 조회 (Peek) - 중간 결과를 출력해 볼 수 있음(디버깅 가능)
        ...
        //  allMatch(): 모든 요소가 true일 경우 true를 리턴
        //  anyMatch(): 하나라도 요소가 true일 경우 true를 리턴
        //  noneMatch(): 모든 요소가  false이면 true를 리턴
