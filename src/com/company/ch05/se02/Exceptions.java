 ...
 *
 *  Throwable 클래스르 상속하는 자식 클래스들로 이러한 문제를 해결
*/
...
//                // 다형성에 의해서 결정된다.
//                // 즉, catch하고 있는 클래스의 자식 클래스의 객체이면 catch 가능
        ...
        try {
            ...
            if(file != null) {
                try {
                    ...
                    System.out.println("앗!.. 아아......ㅋㅋㅋㅋㅋ");
                }
            }
        }

        System.out.println("Program ended normally2");
...
// Unchecked Excepion의 경우에는 throws 키워드를 사용하지 않아도 된다.
